...
(function($) {
	...
	function blum_backgrounds() {
		...
		if ($body.hasClass('slideshow-background')) {
			$body.vegas({
				...
				slides: [
					{ src: '/static/images/demo/images/image-15.jpg' },
					{ src: '/static/images/demo/images/image-16.jpg' },
					{ src: '/static/images/demo/images/image-17.jpg' },
					{ src: '/static/images/demo/images/image-4.jpg' }
				]
			});
		}
		...
		if ($body.hasClass('slideshow-zoom-background')) {
			$body.vegas({
				...
				slides: [
					{ src: '/static/images/demo/images/image-12.jpg' },
					{ src: '/static/images/demo/images/image-15.jpg' },
					{ src: '/static/images/demo/images/image-14.jpg' },
					{ src: '/static/images/demo/images/image-16.jpg' }
				]
			});
		}
		...
		if ($body.hasClass('slideshow-video-background')) {
			$body.vegas({
				...
				slides: [
					{ src: '/static/images/demo/images/image-15.jpg' },
					{ src: '/static/images/demo/video/marine.jpg',
						video: {
							src: [
								'/static/images/demo/video/marine.mp4',
								'/static/images/demo/video/marine.webm',
								'/static/images/demo/video/marine.ogv'
							],
							loop: false,
							mute: true
						}
		...
		if ($body.hasClass('kenburns-background')) {
			...
			var kenburnsBackgrounds = [
				{ src: '/static/images/demo/images/image-15.jpg', valign: 'top' },
				{ src: '/static/images/demo/images/image-14.jpg', valign: 'top' },
				{ src: '/static/images/demo/images/image-17.jpg', valign: 'top' }
			];
	...
	function blum_daycount(){
		var datestart = $('.countdown');

		if(datestart.length > 0){
			setInterval(function() {
				let date1 = '2018/6/8 17:00:00';  //开始时间
				...
				let pastTime = " 距离我们毕业已经过去了 " + days + " 天 " + hours + " 小时 " + minutes + " 分钟 " + seconds + " 秒 ";
				// document.getElementById("pastTime").innerHTML = pastTime;
				datestart.html('<div class="countdown-container row"><div class="countdown-item col-6 col-sm-auto"><div class="number">'+days+'</div><span>天</span></div><div class="countdown-item col-6 col-sm-auto"><div class="number">'+hours+'</div><span>时</span></div><div class="countdown-item col-6 col-sm-auto"><div class="number">'+minutes+'</div><span>分</span></div><div class="countdown-item col-6 col-sm-auto"><div class="number">'+seconds+'</div><span>秒</span></div></div>')
			},1000)
		}
	}
